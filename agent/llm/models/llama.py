...
from agent.llm.models.base import (
    BaseModelArgs,
    create_attention_mask,
    scaled_dot_product_attention,
)
from agent.llm.util.kv_cache import KeyValueCache
from agent.llm.util.rope import initialize_rope
...
class Attention(nn.Module):
    def __init__(self, args: ModelArgs):
        ...
        self.o_proj = nn.Linear(self.n_heads * self.head_dim, dim, attention_bias)
